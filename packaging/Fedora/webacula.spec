...
Patch1:     webacula-7.0.0-path.patch
Patch2:     webacula-7.0.0-apache.patch
...
%changelog
* Wed Apr 15 2015 Robert Oschwald <robertoschwald@gmail.com> 7.0.0-2
- Use systems cache dir
- Load rewrite module conditionally if not loaded already

* Tue Sep 14 2014 Yuri Timofeev <tim4dev@gmail.com> 7.0.0-1
- Version 7.0.0
